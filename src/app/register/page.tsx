    ...
    <div className={isDark ? "dark" : ""}>
      <div className="flex min-h-dvh">
        ...
        <div className="relative hidden w-[45%] overflow-hidden lg:flex lg:flex-col lg:justify-between">
          ...
          <FloatingBubble delay={0.3} size={100} x="15%" y="20%" />
          <FloatingBubble delay={0.5} size={70} x="65%" y="15%" />
          <FloatingBubble delay={0.7} size={50} x="30%" y="70%" />
          <FloatingBubble delay={0.9} size={90} x="60%" y="60%" />
          ...
          <div className="relative z-10 flex flex-1 flex-col justify-center px-12 xl:px-16">
            ...
            >
              ...
              <p className="mt-4 max-w-sm text-base leading-relaxed text-purple-100/80">
                Join thousands of people who trust A-Chat for their daily conversations.
              </p>

              <div className="mt-8 flex flex-wrap gap-2">
                {["Free forever", "No ads", "Private by design"].map((feature, i) => (
                  <motion.span
                    key={feature}
          ...
          <div className="relative z-10 px-12 pb-8 xl:px-16">
            <p className="text-xs text-purple-200/50">A-Chat Messenger</p>
          </div>
        </div>

        {/* Right — Register Form */}
        <div className="bg-mesh relative flex flex-1 items-center justify-center px-6 py-10 sm:px-10">
          <div className="glow absolute -top-32 -right-32 h-64 w-64 rounded-full bg-purple-400/10 blur-3xl lg:hidden" />
          ...
          >
            ...
            <div className="mb-8 lg:hidden">
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-purple-500 to-indigo-600 shadow-lg shadow-purple-500/25">
            ...
            <div className="mb-8">
              ...
              <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">
                Get started with A-Chat for free
              </p>
            </div>
            ...
            <motion.button
              type="button"
              onClick={() => { setGoogleLoading(true); void signIn("google", { callbackUrl: "/" }); }}
